...
<p>The Chillitalk App provides you with a convenient, simple and quick way to make even cheaper calls. What’s more, calls between Chillitalk App users are completely free. The sound quality is crystal-clear
and you can call your contacts with just a few touches on your smartphone or PC.
</p><h3>On which devices can I use the App?</h3> 
<p>You can use the Chillitalk App on Apple & Android smartphones and PCs.  </p>
<h3>How does the App work?</h3> 
<p>The App connects calls via a wireless network – Wi-Fi or 3G.</p>
<h3>Do I need Wi-Fi or 3G to use the App?</h3> 
<p>No, but we recommend connecting to a Wi-Fi network to connect your calls. This way you can make even cheaper 
– maybe free – calls if you call another Chillitalk App user.
</p>
