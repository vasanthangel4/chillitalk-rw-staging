...
<nav class="leftmyaccount">
    <section class="accover">
        <div>
            Available credit <span> <?php echo $this->config->item('currency_symbol_web'); ?>
 ...
 <li><a href="<?php echo base_url(); ?><?php echo $lang; ?>/myaccount/customer_service"> Customer Service</a>  </li>
    ...
    <p class="clearall">
        &nbsp;&nbsp;</p>
    <section class="accover">
    <?php if($this->session->userdata('access_no') == '') { ?>
    
    	<div>
           Country<br/>
            <p>
               <?php echo $this->session->userdata('country_user'); ?>
            </p>
        </div>
        
    <?php }elseif($this->session->userdata('country_user') != '' && $this->session->userdata('access_city') != '' && $this->session->userdata('access_prov') != ''){ ?>
        ...
        <div>
            State<br/>
            <p>
                <?php echo $this->session->userdata('access_prov'); ?>
            </p>
        </div>
    	<div>
            City<br/>
            <p>
                <?php echo $this->session->userdata('access_city'); ?>
            </p>
        </div>
        <div>
            Access Number<br/>
    ...
    <?php }elseif($this->session->userdata('country_user') != '' && $this->session->userdata('access_city') != ''){ ?>
    	<div>
           Country<br/>
            <p>
               <?php echo $this->session->userdata('country_user'); ?>
    ...
    <?php }elseif($this->session->userdata('access_no') != ''){ ?>
