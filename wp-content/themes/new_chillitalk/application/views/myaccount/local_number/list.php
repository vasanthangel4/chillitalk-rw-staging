    ...
    <?php echo lang('local_number.second'); ?>
       <select id="country" name="country" style="width:161px !important;">
       	<?php foreach($countries->List as $val) { ?>
			<?php if($val->Code2 == $this->session->userdata('country2_sidebar') && $this->uri->segment('5') == '') { ?>
        ...
        <?php } ?>        
                    ...
                    <div class="login localxtc">
                            <button type="button" id="change_country">Change Country</button>
...
$(document).ready(function() {
  ...
  $('#change_country').click(function(){  
	window.location.href = '<?php echo base_url(); ?>en/myaccount/local_number/view_by_country/'+$('#country').val();	
  })
