...
<div class="rightcunt" style="margin-left:130px">
  ...
  <h1>Step 2 - Home Saver Bundles </h1>
  ...
  <form name="frm_bundles" id="frm_bundles" action="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/myaccount/home_saver_bundles/step2" method="post" autocomplete="off">   
  
  <div class="cssaver1 leftcom">
  
      <div class="cssaver1 leftcom">
          <label>Destination mobile number*<span>(the international number you wish to call)</span></label>
          <input type="text" name="destination_number" class="leftcom" required pattern="[0-9]+" value="<?php echo set_value('destination_number'); ?>">
      </div>
      
      <div class="cssaver1 leftcom">
          <label>Confirm destination number*</label>
          <input type="text" name="confirm_destination_number" class="leftcom" required pattern="[0-9]+" value="<?php echo set_value('confirm_destination_number'); ?>">
      </div>
      
      <div class="cssaver1 leftcom">
          <label>Your main mobile number*</label>
          <input type="text" name="mobile_number" class="leftcom" required pattern="[0-9]+" value="<?php echo set_value('mobile_number'); ?>" >
      </div>
      ...
      <div class="cssaver1 leftcom">
          ...
          <input type="text" name="first_name" class="leftcom" required value="<?php echo set_value('first_name'); ?>">
      </div>
      
      <div class="cssaver1 leftcom">
          <label>Last Name*</label>
         
          <input type="text" name="last_name" class="leftcom" required value="<?php echo set_value('last_name'); ?>">
      </div>
      
      <div class="cssaver1 leftcom">
          <label>Postcode*</label>
          <input type="text" name="postcode" class="leftcom" required value="<?php echo set_value('postcode'); ?>">
      </div>
      
      <div class="cssaver1 leftcom">
          <label> Street* </label>
          <input type="text" name="street" class="leftcom" value="<?php echo set_value('street'); ?>" required >
      </div>
      
      <div class="cssaver1 leftcom">
          <label> Town* </label>
          <input type="text" name="town" class="leftcom" value="<?php echo set_value('town'); ?>" required >
      </div>
      ...
      <div class="cssaver1 leftcom">
          <div class="signup" style="margin-top:20px;margin-left:20px"> 
            <a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/sign_up/welcome">Back</a>   
          </div>
