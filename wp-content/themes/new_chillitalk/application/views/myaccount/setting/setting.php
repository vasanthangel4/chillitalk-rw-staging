            ...
            <div class="rightcunt">
                ...
                <section class="leftsetting nnbrd">
                    ...
                    <?php if($topup->SubscriptionId == '') { ?>
                            ...
                            <p class="rightcunt2" style="width:340px !important">
                            You currently do not have a credit card saved to your   <br/>account
			   ...
			   usort($countries->List, "compare_weights");
			   
			   ?>
               
               <section id="vasetingd"><br><br><h3>Location</h3>
               <form id="frmlocationid" name="frmlocationname" method="post" action="<?php echo base_url().$this->session->userdata('lang'); ?>/myaccount/setting/change_location">
                 <label> Country</label>
                  <select id="country" name="country" class="leftcom" required >
                  	<?php foreach($countries->List as $val) { ?>
                    	<?php if($val->Code2 == $this->session->userdata('country2_sidebar')) { ?>
                        	<option value="<?php echo $val->Code2; ?>" selected="selected"><?php echo $val->Name; ?></option>                        
                        <?php }else{ ?>
                        	<option value="<?php echo $val->Code2; ?>"><?php echo $val->Name; ?></option>
                        <?php } ?>
                    <?php } ?>
