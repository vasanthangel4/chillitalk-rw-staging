                ...
                <div class="bgmobile1 padg" id="payGContent-1">
                    <h1>
                      ...
                      free call now
                       ...
                       <span class="red">07855 322 950</span></span>
                   ...
                   <div class="formRow js leftcom" >     
                      ...
                      <span class="icon">i</span>
                        ...
                        <div class="tssddx">
                        <span class="leftcom">  Your Access Number <span class="red">1647 558 0200 </span><br/>
is this number local to you?   </span>   <div style="margin:14px 0 0px -51px !important;" id="vasanth" class="formRow js leftcom" >     
                          <span style="display:none;" class="helpText">
                                                              <span>
...
<div class="cjhange" id="signupimg">
 ...
 change  </a>
  ...
  <div class="tssddx" style="display:none;">
 ...
 cancel  </a>
   ...
   <h3 class="red">Option A</h3>                 
                ...
                <h4>Use chillitalk to call right away </h4>
                    <p>
                     	1. Dial  <strong><span class="red">1647 558 0200</span></strong> from your registered phone<br/>
...
.js .helpText .message,.js .helpTextAlt .message
   ...
   background-image: url("http://mundio-test2.azurewebsites.net/wp-content/themes/new_chillitalk/img/popup.png") !important;
	...
	#vasanth .helpText .message,#vasanth  .helpTextAlt .message
	{
  background-image: url("http://mundio-test2.azurewebsites.net/wp-content/themes/new_chillitalk/img/paragh1.png") !important;
  }
