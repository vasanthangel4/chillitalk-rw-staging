  ...
  <section class="apps earnm">
    ...
    <form method="POST">
      <div id="radios1">
           ...
           <input type="radio" id="tim1" value="landline" name="group1" checked="checked" 
           ...
           disabled:'<?php echo get_template_directory_uri(); ?>/img/landlineandmobile.jpg' }" title="landline" />
    
           <input type="radio" id="tim2" onclick="toggle('hide');" value="android" name="group1" 
           ...
           disabled:'<?php echo get_template_directory_uri(); ?>/img/android.png'}" title="android" />
             
           <input type="radio" id="tim3" onclick="toggle('hide');" value="iPhone & iPad" name="group1"  
           ...
           disabled:'<?php echo get_template_directory_uri(); ?>/img/iphone2.png'}" title="iPhone" />
           ...
           disabled:'<?php echo get_template_directory_uri(); ?>/img/PC-diselect.png'}" title="PC"/>
    ...
    <div id="landline">
    	<h3 style="display:inline !important;float:left !important;text-align:left !important;width: 700px !important;text-indent:0px !important;">
        2. Sign-up here</h3>
          ...
          <div class="appbgcl">
            ...
            <form name="frm-signup" id="frm-signup" method="post" action="<?php echo current_url(); ?>">
                ...
                <div>
                    ...
                    <!--<input type="text" class="<?php echo $this->session->userdata('small_flag'); ?>" value="+<?php echo $this->config->item('prefix_phone_web'); ?>" name="UK" readonly="readonly">-->
