                ...
                <div class="bgmobile1 padg" id="payGContent-1">
                   ...
                   <div class="formRow js leftcom" >     
                      ...
                      <span class="icon">i</span>
                        ...
                        <span class="leftcom">  Your Access Number <span class="red"><?php if($this->session->userdata('new_access_no') != '') {
...
is this number local to you?   </span>   <div style="margin:14px 0 0px -51px !important;" class="formRow js leftcom" >     
   ...
   <h3 class="red" style="margin-top:70px;">Option A</h3>                 
                        
                <div class="bgsign" style="margin-top:-4px;">       
...
put in your friend's international number and we'll give you a number to call them at your local rate
                    ...
                    <form name="frm_step2" method="post" action="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/sign_up/step2_oan"  id="txtlable">
