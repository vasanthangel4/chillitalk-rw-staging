...
<div class="maincomon" style="margin:-41px 0 0;">
  <section class="rates">
   ...
   <article class="ratesshown1">
 <span>
            from: <select class="fromCountry" id="fromCountry" name="fromCountry" >
                                ...
                                <div class="controls controls-row">
                                    <div class="control">
                                        <span class="wrap-autocomplete wrap-select-country wrap-input-large" id="innerrates">
                                            <select name="country" style="width:329px !important;" id="countries" class="select-country input-large selectratea" title="Select the country you want to call"
...
<p><b style="font-size: 22px;">Cheap and easy</b><br /><br />
...
<a href='<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/chillitalk_access_number/'>


Local Access Number </a>
...
<br/><br/><b>Call from anywhere</b>  – The Chillitalk App works anywhere in the world, 
while you can call from your local network in more than <a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/chillitalk_countries"> 50 countries </a>
<br/><br/><b>No hidden charges</b>  – Pay our per-minute rates – and not a penny more
<br/><br/><br/>
</p>
...
$(document).ready(function() {
    $('#Currency').on('change', function(evt) {
        //var optionSelected = $('option:selected', this);
        var valueSelected = $(this).val();
        console.log('currency:', valueSelected);
        var country = $('#countries').find('option:selected').val();
        console.log('country:', country);
        console.log('landline:', $('#landline').text().split(' ')[0]);
        console.log('mobile:', $('#mobile').text().split(' ')[0]);
        console.log('sms:', $('#sms').text().split(' ')[0]);
    });
